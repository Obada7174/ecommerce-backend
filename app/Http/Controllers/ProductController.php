...
class ProductController extends Controller
{
    ...
    {
        $products = Product::with('Images')->where('status', '=', 'published')->latest()->take(12)->get();
        return $products;
    }

    public function getTopRated(Request $request)
    {
        $products = Product::with('Images')->where('status', '=', 'published')->where('rating', '>=', '4.5')->latest()->take(12)->get();
        return $products;
    }
